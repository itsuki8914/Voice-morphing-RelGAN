...
def main():
    ...
    model_name = 'relgan_vc2_two_step'
    ...
    while iteration <= num_iterations:
        ...
        #print(alp)
        generator_loss, discriminator_loss, gen_adv_loss, gen_cond_loss, gen_int_loss, gen_rec_loss, gen_self_loss, dis_adv_loss, dis_cond_loss, dis_int_loss, intab, intal, lossf, lossb, lossm, losst= model.train(input_A=x, input_A2=x2, input_B=y, input_C=z, label_A=x_labels, label_B=y_labels, label_C=z_labels,
        ...
        if iteration % 10 == 0:
            ...
            print("losf=%.3e losb=%.3e, losm=%.3e lost=%.3e"%(lossf, lossb, lossm, losst))
        ...
        if iteration % 1000 == 0 :
            for q in range(2):
                ...
                for file in glob.glob(eval_A_dir + '/*.wav'):
                    ...
                    #coded_sp_converted_norm = np.clip(coded_sp_converted_norm, -1+1e-12, 1-1e-12)
